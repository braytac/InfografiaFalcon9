...
const X_VIS_LEFT = -700;
const X_VIS_RIGHT = 600;
...
const inicializar = (modo) => {
    ...
    cargarArchivoJSON("data.json", function (jsonData) {
        ...
        networkLR.moveTo({ scale: 1.4, position: { x: x_vis_export_left, y: 0 } });
        networkRL.moveTo({ scale: 1.4, position: { x: x_vis_export_right, y: 0 } });
    });
}
// e. handlers
